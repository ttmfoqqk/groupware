					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form id="rule-form-write-setting" action="<?echo $action_url;?>" method="post" class="form-horizontal group-border stripped" role="form" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="name" class="col-lg-2 col-md-2 control-label lb-left-align"><font class="red">* </font> 점수</label>
									...
									<div class="col-lg-5 col-md-5">
										<input id="point" name="point" type="text" class="form-control" placeholder=""  maxlength="20" value=<?php echo $data['point']?>>
									</div>
								</div>
								<div class="form-group">
									<div class="col-xs-12">
