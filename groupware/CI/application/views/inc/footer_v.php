        ...
        <div id="footer" class="clearfix sidebar-page">
            <!-- Start #footer  -->
            <p class="pull-left">
                Copyrights &copy; 2015 <a href="#" class="color-blue strong" target="_blank">(주)스파이더웹</a>. All rights reserved.
            </p>
            <p class="pull-right">
        ...
        <script src="<?echo $this->config->base_url()?>html/js/libs/modernizr.custom.js"></script>
        <!-- Handle responsive view functions -->
        <script src="<?echo $this->config->base_url()?>html/js/jRespond.min.js"></script>
        ...
        <script src="<?echo $this->config->base_url()?>html/plugins/core/velocity/jquery.velocity.min.js"></script>
        <!-- Quick search plugin (fast search for many widgets) -->
        <script src="<?echo $this->config->base_url()?>html/plugins/core/quicksearch/jquery.quicksearch.js"></script>
        <!-- Bootbox fast bootstrap modals -->
        <script src="<?echo $this->config->base_url()?>html/plugins/ui/bootbox/bootbox.js"></script>
