								...
								<table class="table table-bordered" id="tabletools">
									...
									<?php
										...
										<tr>
											...
											<td><a class="text-normal"><?php echo $lt['order'];?></a></td>
											...
											<td><a class="text-normal">
												<div class="input-daterange input-group">
													...
													<input type="text" class="form-control" name="ft_start"
														id="ft_start"
														value=<?php if($lt['date'] != '1') echo "'" .$lt['date'] . "'";?> />
												</div>
												</a>
											</td>
											<td class="text-center">
												<div class="btn btn-success " onclick="alert('휴일 생성');">+</div>
												<div class="btn btn-danger " onclick="alert('휴일 제거');">-</div>
											</td>
										</tr>
									<?php }?>
									<!-- 리스트 -->
