				...
				<div class="col-lg-12">
					...
					<div class="panel panel-primary toggle">
						...
						<div class="panel-body">
							<!-- 검색 -->
							<form id="qu" class="form-horizontal" method="get" role="form" action="<?echo site_url('document/lists/');?>">
								...
								<div class="form-group col-lg-12 col-md-12">
									...
									<div class="col-lg-3 col-md-3">
										<select class="fancy-select form-control" id="menu_no" name="menu_no" data-method="document" data-value="<?echo $this->input->get('menu_no');?>">
								...
								<div class="form-group col-lg-12 col-md-12">
									...
									<div class="col-lg-3 col-md-3">
										<select class="fancy-select form-control" id="is_active" name="is_active">
                                        	<option value="">전체</option>
                                        	<option value="0" <?=$this->input->get('is_active') == '0' ? 'selected' : '';?>>사용</option>
                                        	<option value="1" <?=$this->input->get('is_active') == '1' ? 'selected' : '';?>>미사용</option>
                                        </select>
									</div>
							...
							<form id="document-form-list" action="<?echo $action_url;?>" method="post" class="form-horizontal group-border stripped" role="form">
