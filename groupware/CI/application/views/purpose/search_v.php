				...
				<div class="col-lg-12">
					...
					<div class="panel panel-primary toggle">
						...
						<div class="panel-heading">
							<h4 class="panel-title"><i class="fa fa-circle"></i> 목표설정</h4>
						</div>
						<div class="panel-body">
							...
							<form class="form-horizontal">
								...
								<div class="form-group">
									...
									<label class="col-lg-2 col-md-2 col-sm-2 control-label" for="">복지</label>
									<div class="col-lg-3 col-md-3 col-sm-3">
										<select id="board_type" name="board_type" class="fancy-select form-control">
							...
							<div class="panel hidden-sm hidden-xs">
								...
								<div class="panel-body text-center">
									<div class="col-lg-3 col-md-3">
										<b class="text-success">승진기준</b>
									</div>
									<div class="col-lg-3 col-md-3">
										<b class="text-success">연봉협상</b>
									</div>
									<div class="col-lg-3 col-md-3">
										<b class="text-success">인센티브</b>
									</div>
									<div class="col-lg-3 col-md-3">
										<b class="text-success">연금적용</b>
									</div>
								</div>
							</div>
							<div class="panel-primary">
							...
							<div class="panel hidden-sm hidden-xs">
								...
								<div class="panel-body text-center">
									<div class="col-lg-3 col-md-3">
										<b class="text-primary">팀회식</b>
									</div>
									<div class="col-lg-3 col-md-3">
										<b class="text-primary">팀 인센티브</b>
									</div>
									<div class="col-lg-3 col-md-3">
										<b class="text-primary">문화상품권</b>
									</div>
								</div>
							</div>
							<div class="panel-primary">
							...
							<div class="panel hidden-sm hidden-xs">
								...
								<div class="panel-body text-center">
									<div class="col-lg-3 col-md-3">
										<b class="text-muted">식대</b>
									</div>
									<div class="col-lg-3 col-md-3">
										<b class="text-muted">워크샵</b>
									</div>
								</div>
							</div>
							<div class="panel-primary">
